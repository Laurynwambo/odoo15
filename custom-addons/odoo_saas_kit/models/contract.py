...
class SaasContract(models.Model):
    ...
    total_cycles = fields.Integer(string="Purchase Cycle (Remaining/Total)", default=1)
    ...
    free_users = fields.Integer(string="Free Users", default=0)
    ...
    def send_invoice_mail(self, invoice):
        ...
        body = template._render_template(template.body_html, 'account.move', [invoice.id]).get(invoice.id)
